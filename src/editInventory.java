 ...
 */
public class editInventory extends Mainclass{
    int add;
    int sub;
    boolean eLoop = true;
    ...
    Scanner scan = new Scanner(System.in);
        ...
        do{
            ...
            case '3': //EDITMENU REMOVE
             //REMOVE
                    char choicesubmenu=m.subInventoryMenu();
                    act = 'r';
    ...
    public void addItem(char a, char act){
        Factory f = new Factory();
        Item item = f.createObj(a, act);
    }
    
    public void remItem(char r, char act){
        Factory f = new Factory();
        Item item = f.createObj(r, act);
    }
}
